...
(defvar ack-command "ack --nocolor --nogroup --type-add erb=.erb,.rhtml" "The command run by the ack function.")
...
defined by the ack-command variable."
  (interactive (list (read-file-name "Run ack in directory: " nil "" t)
                     ...
                     (read-string "Ack arguments: " "-i --html --erb --ruby --css --yaml --js" nil "-i --html --erb --ruby --css --yaml --js" nil)
                                  ))
